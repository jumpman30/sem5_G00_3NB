...
export default interface ITaskService {
  save(task: requestSurveillanceTaskDto | requestPickupDeliveryTaskDto): Promise<Result<responseTaskDto>>;
  update(task: requestSurveillanceTaskDto | requestPickupDeliveryTaskDto): Promise<Result<responseTaskDto>>;
